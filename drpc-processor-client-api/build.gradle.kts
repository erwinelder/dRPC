...
mavenPublishing {
    ...
    coordinates(groupId = group.toString(), artifactId = "drpc-processor-client-api", version = version.toString())

    pom {
        name = "dRPC Processor Client API"
        description = "Docta Remote Procedure Call (Processor Client API) built on top of Kotlin/Ktor."
        inceptionYear = "2025"

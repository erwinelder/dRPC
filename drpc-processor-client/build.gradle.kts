...
mavenPublishing {
    ...
    coordinates(groupId = group.toString(), artifactId = "drpc-processor-client", version = version.toString())

    pom {
        name = "dRPC Client Processor"
        description = "Docta Remote Procedure Call (Client Processor) built on top of Kotlin/Ktor."
        inceptionYear = "2025"

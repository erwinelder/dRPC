...
mavenPublishing {
    ...
    coordinates(groupId = group.toString(), artifactId = "drpc-processor-core-api", version = version.toString())

    pom {
        name = "dRPC Processor Core API"
        description = "Docta Remote Procedure Call (Processor Core API) built on top of Kotlin/Ktor."
        inceptionYear = "2025"

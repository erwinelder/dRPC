...
class MainIntegrationTest {
    ...
    @Test
    fun `client can call service function`() = runTest {
    ...
    @Test
    fun `main module can call another module`() = runTest {
        val response = httpClient.post("http://localhost:8080/ping-service1")
